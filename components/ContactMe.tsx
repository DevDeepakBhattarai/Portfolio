...
export default function ContactMe({}: Props): ReactElement {
  ...
  return (
    <div className="h-screen relative overflow-hidden isolate">
      ...
      <div className="h-full flex flex-row-reverse justify-center lg:justify-start items-center pt-10 pb-28">
        <div className="bg-white max-h-[50rem] lg:max-h-[60rem] h-full w-96 shadow-2xl lg:mr-32 shadow-white/50  overflow-y-scroll scrollbar-none">
        ...
        <div className="bg-blue-500 max-h-[55rem] lg:max-h-[65rem]  h-full w-24 md:w-32 flex flex-col justify-center items-center gap-4  scale-105 ring ring-inset ring-red-100">
