import{a as t,j as e,m as r}from"./index-ba37d970.js";import{T as s}from"./Title-a0888cc8.js";const l=[{logo:"/js.png",completeness:"95%"},{logo:"/react.png",completeness:"70%"},{logo:"/next.png",completeness:"70%"},{logo:"/node.png",completeness:"90%"},{logo:"/mysql.png",completeness:"70%"},{logo:"/html.png",completeness:"90%"},{logo:"/css.png",completeness:"70%"},{logo:"/tailwindcss.svg",completeness:"95%"}];function c({}){return t("div",{className:"h-screen flex flex-col ",children:[e(s,{firstPart:"Ski",secondPart:"lls"}),e("div",{className:"h-full flex items-center justify-center p-4",children:e("div",{className:"flex flex-row items-center justify-center flex-wrap gap-2 md:gap-4 lg:p-16",children:l.map((o,n)=>t(r.div,{initial:{opacity:0},whileInView:{opacity:1,transition:{duration:1,delay:n*Math.random()*.1}},viewport:{once:!0},tabIndex:0,className:`\r
            \r
